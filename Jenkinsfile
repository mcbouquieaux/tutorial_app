...
pipeline {
    ...
    environment {
        author_name = "Marie-Catherine Bouquieaux"
        author_email = "mcbouquieaux@gmail.com"
        app_name = "tutorial_app"
        job_location = "Pipeline-as-code/DEEP-OC-org/UC-mcbouquieaux-DEEP-OC-tutorial_app/${env.BRANCH_NAME}"
    }
